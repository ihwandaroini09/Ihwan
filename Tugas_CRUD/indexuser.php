...
<html>
 ...
 <body>
 	<form class="form-inline my-2 my-lg-0" action="cariuser.php" method="GET">
      <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" width="100px">
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="cari" formaction="cariuser.php">Search</button>
    </form>

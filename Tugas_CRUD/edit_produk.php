...
include 'koneksi.php';
 ...
 // apabila data tidak ada pada database maka akan dijalankan
...
$data['deskripsi']; ?>" />
 ...
 <input type="text" name="harga_beli" required=""value="<?php
echo $data['harga_beli']; ?>" />
 </div>
 <div>
 <label>Harga Jual</label>
 <input type="text" name="harga_jual" required="" value="<?php
...
style="width: 120px;float: left;margin-bottom: 5px;">
 ...
 <i style="float: left;font-size: 11px;color: red">Abaikan
jika tidak merubah gambar produk</i>
 </div>
 <div>
